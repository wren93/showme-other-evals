    ...
    def forward(
        ...
        if input_dtype == torch.float32:
            ...
            # Handle the case where the model is quantized
                ...
                target_dtype = self.config._pre_quantization_dtype  # pyre-ignore
            else:
...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def forward(
        self,
        input_ids: torch.LongTensor = None,  # pyre-ignore
        attention_mask: Optional[torch.Tensor] = None,
        position_ids: Optional[torch.LongTensor] = None,
        ...
        use_cache = (
            use_cache if use_cache is not None else self.config.use_cache  # pyre-ignore
        )
        ...
        if cache_position is None:
            past_seen_tokens = (
                past_key_values.get_seq_length()  # pyre-ignore
    ...
    def _update_causal_mask(
        ...
        if (
            ...
            if AttentionMaskConverter._ignore_causal_mask_sdpa(
                ...
                sliding_window=self.config.sliding_window,  # pyre-ignore
        ...
        causal_mask = self._prepare_4d_causal_attention_mask_with_cache_position(
            ...
            target_length=target_length,  # pyre-ignore
            dtype=dtype,
            device=device,
            cache_position=cache_position,
            batch_size=input_tensor.shape[0],
            config=self.config,  # pyre-ignore
...
class Qwen2ForSequenceClassification(Qwen2PreTrainedModel):
    ...
    def forward(
        ...
        if input_ids is not None:
            ...
            batch_size = inputs_embeds.shape[0]  # pyre-ignore
        ...
        loss = None
        if labels is not None:
            labels = labels.to(logits.device)  # pyre-ignore

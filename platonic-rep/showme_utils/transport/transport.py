...
from showme_utils.transport import path
from showme_utils.transport.integrators import ode, sde
from showme_utils.transport.utils import expand_dims, mean_flat
...
class Transport:
    ...
    def time_shift(self, mu: float, sigma: float, t: th.Tensor):
        ...
        t = 1 - t
        t = math.exp(mu) / (math.exp(mu) + (1 / t - 1) ** sigma)  # pyre-ignore
        t = 1 - t
        return t

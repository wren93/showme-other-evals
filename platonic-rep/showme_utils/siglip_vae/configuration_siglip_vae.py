...
class SiglipVisionConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        patch_size_vae=8,
        patch_size_post_vae=2,
        vae_type="wan_2_1",
        vae_path="./Wan2.1_VAE.pth",
        vae_z_dim=16,
        vae_init_decoder=False,
        vae_use_projection=False,
        ...
        **kwargs,
        ...
        self.hidden_act = hidden_act
        # additional arguments
        self.patch_size_vae = patch_size_vae
        self.patch_size_post_vae = patch_size_post_vae
        self.patch_size = patch_size_vae * patch_size_post_vae
        self.vae_type = vae_type
        assert vae_type in [
            "wan_2_1",
            "wan_2_2",
        ], "vae_type must be 'wan_2_1' or 'wan_2_2'"
        self.vae_path = vae_path
        self.vae_z_dim = vae_z_dim
        self.vae_init_decoder = vae_init_decoder
        self.vae_use_projection = vae_use_projection
        self.vae_deterministic = vae_deterministic

    def update(self, config_dict: dict[str, Any]):
        super().update(config_dict)
        self.patch_size = self.patch_size_vae * self.patch_size_post_vae

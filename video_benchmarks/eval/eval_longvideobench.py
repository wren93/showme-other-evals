...
def main(
    ...
    data_dir="/path/to/datasets/LongVideoBench",
    num_frames=512,
    ...
    for question_type in question_type_dict:
        ...
        print(
            f"Accuracy: {question_type_dict[question_type]['correct']} / {question_type_dict[question_type]['total']:.4f} = {question_type_dict[question_type]['correct'] / question_type_dict[question_type]['total']:.4f}"
        )
        print()
